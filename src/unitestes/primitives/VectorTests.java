...
public class VectorTests {
	...
	public void testCrossProduct() {
		...
		// TC10 Test that length of cross-product is proper (orthogonal vectors taken
		// for simplicity)
	...
	public void testNormalize() {
		...
		/*
		 * v = new Vector(0,0,0); try { v.normalize();
		 * fail("Didn't throw divide by zero exception!"); } catch (ArithmeticException
		 * e) { assertTrue(true); }
		 */
	}
