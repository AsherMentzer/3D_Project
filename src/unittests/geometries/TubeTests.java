...
public class TubeTests {
		...
		public void testFindIntersections() {
			...
			List<GeoPoint> result = tube.findGeoIntersections(ray);
			...
			result = tube.findGeoIntersections(ray);
			...
			tube = new Tube(new Ray(new Point3D(0, 0, 0), new Vector(0, 0, 1)), 1);
			ray = new Ray(new Point3D(1, 0, 0), new Vector(-1, 0, 0));
			result = tube.findGeoIntersections(ray);
		...
		public void testFindIntersectionsRay_DanZilberstein() {
			...
			List<GeoPoint> result = tube2.findGeoIntersections(ray);
